...
One SDK so every consuming app (Orange Way, BitBooks, and other integrators) verifies webhook deliveries identically.
...
For now, consumers inside the Orange Rails monorepo workspace can pull it via a workspace dependency or a git URL.
