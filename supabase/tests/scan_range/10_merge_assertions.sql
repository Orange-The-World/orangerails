...
DO $$
BEGIN
  IF to_regprocedure('public.record_stealth_scan_range(uuid,int,int,text,uuid)') IS NULL THEN
    RAISE EXCEPTION
      'PRECONDITION FAILED: the fenced 5-arg record_stealth_scan_range does not exist. The migrations did not load, so nothing below would have tested anything.';
  END IF;

  IF to_regprocedure('public.record_stealth_scan_range(uuid,int,int,text)') IS NOT NULL THEN
    RAISE EXCEPTION
      'PRECONDITION FAILED: the pre-fence 4-arg record_stealth_scan_range overload still exists. A caller with no scan_generation could bypass the OR-T2457 fence by calling it directly.';
  END IF;
  ...
  RAISE NOTICE 'ok  precondition  ->  fenced 5-arg function present, 4-arg and 3-arg overloads absent';
END $$;

BEGIN;

-- Every connection gets the SAME fixed scan_generation (OR-T2457). A case
-- that expects a write to succeed passes this same constant to
-- record_stealth_scan_range and it matches; a case that expects a refusal
-- is refused on the ownership check before the generation is ever compared,
-- so the constant is present there only because the function is now 5-arg,
-- not because it has to match anything.
INSERT INTO public.stealth_connections (id, app_user_id, scan_generation) VALUES
  ('00000000-0000-0000-0000-0000000000a1', 'user-a', '10101010-1010-1010-1010-101010101010'),
  ('00000000-0000-0000-0000-0000000000a2', 'user-a', '10101010-1010-1010-1010-101010101010'),
  ('00000000-0000-0000-0000-0000000000a3', 'user-a', '10101010-1010-1010-1010-101010101010'),
  ('00000000-0000-0000-0000-0000000000a4', 'user-a', '10101010-1010-1010-1010-101010101010'),
  ('00000000-0000-0000-0000-0000000000a5', 'user-a', '10101010-1010-1010-1010-101010101010'),
  ('00000000-0000-0000-0000-0000000000a6', 'user-a', '10101010-1010-1010-1010-101010101010'),
  ('00000000-0000-0000-0000-0000000000a7', 'user-a', '10101010-1010-1010-1010-101010101010'),
  ('00000000-0000-0000-0000-0000000000a8', 'user-a', '10101010-1010-1010-1010-101010101010'),
  ('00000000-0000-0000-0000-0000000000a9', NULL, '10101010-1010-1010-1010-101010101010');

-- Case 1. Empty table: a plain insert, nothing to merge with.
SELECT public.record_stealth_scan_range('00000000-0000-0000-0000-0000000000a1', 100, 200, 'user-a', '10101010-1010-1010-1010-101010101010');
...
SELECT public.record_stealth_scan_range('00000000-0000-0000-0000-0000000000a1', 150, 250, 'user-a', '10101010-1010-1010-1010-101010101010');
...
SELECT public.record_stealth_scan_range('00000000-0000-0000-0000-0000000000a2', 100, 200, 'user-a', '10101010-1010-1010-1010-101010101010');
SELECT public.record_stealth_scan_range('00000000-0000-0000-0000-0000000000a2', 201, 300, 'user-a', '10101010-1010-1010-1010-101010101010');
...
SELECT public.record_stealth_scan_range('00000000-0000-0000-0000-0000000000a3', 100, 200, 'user-a', '10101010-1010-1010-1010-101010101010');
SELECT public.record_stealth_scan_range('00000000-0000-0000-0000-0000000000a3', 50, 99, 'user-a', '10101010-1010-1010-1010-101010101010');
...
SELECT public.record_stealth_scan_range('00000000-0000-0000-0000-0000000000a4', 100, 200, 'user-a', '10101010-1010-1010-1010-101010101010');
SELECT public.record_stealth_scan_range('00000000-0000-0000-0000-0000000000a4', 120, 180, 'user-a', '10101010-1010-1010-1010-101010101010');
...
SELECT public.record_stealth_scan_range('00000000-0000-0000-0000-0000000000a5', 120, 180, 'user-a', '10101010-1010-1010-1010-101010101010');
SELECT public.record_stealth_scan_range('00000000-0000-0000-0000-0000000000a5', 100, 200, 'user-a', '10101010-1010-1010-1010-101010101010');
...
SELECT public.record_stealth_scan_range('00000000-0000-0000-0000-0000000000a6', 300, 400, 'user-a', '10101010-1010-1010-1010-101010101010');
SELECT public.record_stealth_scan_range('00000000-0000-0000-0000-0000000000a6', 100, 200, 'user-a', '10101010-1010-1010-1010-101010101010');
...
SELECT public.record_stealth_scan_range('00000000-0000-0000-0000-0000000000a6', 201, 299, 'user-a', '10101010-1010-1010-1010-101010101010');
...
SELECT public.record_stealth_scan_range('00000000-0000-0000-0000-0000000000a7', 100, 200, 'user-a', '10101010-1010-1010-1010-101010101010');
SELECT public.record_stealth_scan_range('00000000-0000-0000-0000-0000000000a7', 202, 300, 'user-a', '10101010-1010-1010-1010-101010101010');
...
SELECT public.record_stealth_scan_range('00000000-0000-0000-0000-0000000000a8', 500, 500, 'user-a', '10101010-1010-1010-1010-101010101010');
SELECT public.t_assert_ranges('9a single-height range is stored as itself',
       '00000000-0000-0000-0000-0000000000a8', '[500,500]');
SELECT public.record_stealth_scan_range('00000000-0000-0000-0000-0000000000a8', 501, 501, 'user-a', '10101010-1010-1010-1010-101010101010');
SELECT public.record_stealth_scan_range('00000000-0000-0000-0000-0000000000a8', 499, 499, 'user-a', '10101010-1010-1010-1010-101010101010');
...
SELECT public.t_assert_refused('10a a caller who does not own the connection is refused',
       '00000000-0000-0000-0000-0000000000a1'::uuid, 100, 200, 'not-the-owner', '10101010-1010-1010-1010-101010101010'::uuid);

SELECT public.t_assert_refused('10b a connection with no owner is refused',
       '00000000-0000-0000-0000-0000000000a9'::uuid, 100, 200, NULL, '10101010-1010-1010-1010-101010101010'::uuid);

SELECT public.t_assert_refused('10c an unknown connection id is refused',
       '00000000-0000-0000-0000-0000000000ff'::uuid, 100, 200, 'user-a', '10101010-1010-1010-1010-101010101010'::uuid);
...
-- untouched.
INSERT INTO public.stealth_connections (id, app_user_id, scan_generation)
VALUES ('00000000-0000-0000-0000-0000000000b1', 'user-b', '10101010-1010-1010-1010-101010101010');

SELECT public.t_assert_refused('11a user-b cannot write against user-a''s connection',
       '00000000-0000-0000-0000-0000000000a1'::uuid, 1, 999999, 'user-b', '10101010-1010-1010-1010-101010101010'::uuid);

SELECT public.t_assert_ranges('11b user-a''s ranges are untouched by the refused write',
       '00000000-0000-0000-0000-0000000000a1', '[100,250]');

SELECT public.record_stealth_scan_range('00000000-0000-0000-0000-0000000000b1', 700, 800, 'user-b', '10101010-1010-1010-1010-101010101010');
