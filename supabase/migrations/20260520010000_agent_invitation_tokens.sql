...
-- See: https://wiki.abascal.ca/doc/09-decisions-log-phase-1-kickoff-H8twQYcNQA (Decision 3: 7-day TTL)
...
--
-- Mint and redeem functions live in subsequent migrations (PR #3 and PR #4
-- respectively).
