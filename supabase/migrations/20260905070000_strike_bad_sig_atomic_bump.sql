...
-- OUT-OF-ORDER-OK: fzwmnzmtqidumdqjdddz additive only, new SECURITY DEFINER function scoped to service_role, no existing objects touched; independent of every migration currently ahead of it, safe to apply out of order.
--
