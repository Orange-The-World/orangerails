...
-- OUT-OF-ORDER-OK: fzwmnzmtqidumdqjdddz additive only, two new columns with defaults on public.connections; independent of every migration currently ahead of it, safe to apply out of order.
--
