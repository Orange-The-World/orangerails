...
--
-- RENUMBERED from 20260827183000 on 2026-09-09: the original timestamp was below dev's ledger
-- max (20260909010000) and would have tripped out_of_order_scan. The old file was removed in
-- the same PR commit. Content is identical.
