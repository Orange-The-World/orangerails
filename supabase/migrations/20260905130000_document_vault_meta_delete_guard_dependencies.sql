...
-- OUT-OF-ORDER-OK: fzwmnzmtqidumdqjdddz comment-only migration (COMMENT ON FUNCTION), no schema or behavior change, and the target function's signature is unaffected by every migration currently ahead of it; safe to apply after any of them.
--
