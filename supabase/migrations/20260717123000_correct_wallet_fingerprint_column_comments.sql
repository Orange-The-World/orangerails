...
-- The real scheme is computeWalletFingerprint in
...
-- 2026-07-15, so dev's catalog still holds the wrong text and only
-- a migration can reach it. This file carries the corrected text
-- forward.
--
