...
-- See: https://wiki.abascal.ca/doc/10-phase-1-gap-analysis-what-exists-vs-what-to-build-r7mRAOazFh
...
COMMENT ON TYPE public.agent_role IS
  'Permission tier for an agent member. read_only < bookkeeper < accountant < owner. See https://wiki.abascal.ca/doc/05-mcp-tool-catalog-v1-books-domain-rewexRn6Sb for the role->tool matrix.';
...
CREATE TABLE IF NOT EXISTS public.agent_members (
  ...
  -- Display + telemetry
  agent_name            TEXT            NOT NULL,         -- "Claude on the maintainer's laptop"
