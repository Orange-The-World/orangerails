...
-- 20260424120000) lived only on the maintainer's Vercel and was never recorded in
...
--   1. the maintainer updates Vercel OR_PLATFORM_API_KEY to the new value on all
--      three scopes (Production, Preview, Development) and stages a
--      redeploy.
--   2. the maintainer confirms ready.
--   3. THIS migration is merged to OR prod (CI applies via Mgmt API).
--   4. the maintainer triggers the Vercel redeploy. the V2 tenant starts sending the
