...
const KB_BASE = "https://support.bitbooks.com/sync";
...
export const ERROR_CATALOG: Record<string, ErrorCatalogEntry> = {
  ...
  ADAPTER_CONFIG_ERROR: {
    ...
    action: "Reconnect this account",
    help_url: `${KB_BASE}/setup-incomplete`,
  },
  UPSTREAM_OTHER: {
