 ...
 *
 * Provider roadmap (OrangeRails-Protocol.html section 18):
...
// credentialShape is passed through so the credential form is derived
// from the manifest (authoritative) rather than the legacy hardcoded map.
