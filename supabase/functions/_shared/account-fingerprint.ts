 ...
 *   128 bits of CSPRNG output (crypto.randomUUID). Minted once on first
 *   connect. Derived from nothing. Zero information content. Cannot be
 *   reversed, confirmed, or correlated across accounts or organisations.
 *   Never rotate: this identifier is stable forever.
 *
 ...
 *
 * 128 bits of CSPRNG output (UUIDv4). Minted once on first connect. Derived
 * from nothing. Zero information content: cannot be reversed, confirmed, or
 * correlated across accounts or organisations even if the value is observed.
 * This identifier is stable forever; do not rotate it.
 */
