...
export async function handleEvent(
  ...
  if (!sub.opk_public) {
    // No OPK registered. Status already reconciled above (DL-0441). Return deferred so the
    // main loop stamps opk_deferred_at and the batch query skips this row until a
