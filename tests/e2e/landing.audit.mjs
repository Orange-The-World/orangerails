// Landing-page surface validation
//
// Covers:
...
//   * Footer — no product-family branding line, Support link goes to support.orangerails.com
...
test('A1-A7: landing page audit assertions', async () => {
  ...
  try {
    ...
    STEP(7, 'A5 — Footer does not reference any product family brand');
    if (/Part of the [A-Za-z ]*BitBooks[A-Za-z ]* family/i.test(bodyText)) {
      throw new Error('Footer references product family brand (should be generic)');
    }
