/* @ts-self-types="./or_bip158_wasm.d.ts" */
 ...
 * @param {Uint8Array} filter_bytes
 * @param {Uint8Array} block_hash
 * @param {Array<any>} scripts
 * @returns {boolean}
 */
export function match_any(filter_bytes, block_hash, scripts) {
    const ptr0 = passArray8ToWasm0(filter_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(block_hash, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.match_any(ptr0, len0, ptr1, len1, scripts);
    if (ret[2]) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('or_bip158_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
