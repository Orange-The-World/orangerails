 ...
 * say whether anything was saved: this is called both before a write and again
 * on the bytes that write returned, and those two situations owe the user
 * different sentences. The caller adds that.
 *
