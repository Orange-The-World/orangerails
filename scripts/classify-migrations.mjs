...
const EXPECTED = {
  ...
  '20990101000013_reversible_dollar_quoted_argument.sql': { verdict: REVERSIBLE, id: null },
  '20990101000014_irreversible_dollar_quoted_argument.sql': { verdict: IRREVERSIBLE, id: 'TRUNCATE' },
};
