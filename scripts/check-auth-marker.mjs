 ...
 * Migrating each is tracked in OR-T1040 (every name on this list) -- not
 * a new ticket per function, because it already covers the full sweep
...
note(
  ...
  `${exceptioned} known exception(s) pending migration (OR-T1040).`);
