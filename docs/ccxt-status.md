...
Four CCXT capabilities matter to OR sync:
...
* **fetchBalance** — `fetchBalance` available, OR uses this to validate credentials on connect
...
| Exchange | Slug | Countries | Trades | Deposits | Withdrawals | fetchBalance | Cred shape |
|----------|------|-----------|--------|----------|-------------|--------------|------------|
