...
11. [Mining pool events: earnings and payouts](#mining-pool-events-earnings-and-payouts)
12. [Wire-format gotchas (read before integrating)](#wire-format-gotchas-read-before-integrating)
13. [Adding a provider (for OR maintainers)](#adding-a-provider-for-or-maintainers)
