...
//
// Run standalone:   node server/providers/surge/mock.js   (defaults to :3099)
// Use in tests:     const app = require('./providers/surge/mock'); supertest(app)...
//
...
const POSITIONS = require('./fixtures/positions.json')
const SUMMARY = require('./fixtures/summary.json')
const ACCT = require('./fixtures/accounting-state.json')
